...
class AutomationsGetResponseData extends JsonSerializableType
{
    ...
    /**
     * @var AutomationsGetResponseDataTrigger $trigger The event and conditions that trigger this automation.
     */
    #[JsonProperty('trigger')]
    private AutomationsGetResponseDataTrigger $trigger;

    /**
     * @var array<AutomationsGetResponseDataWorkflowItem> $workflow The sequence of tasks to be executed when the automation is triggered. The structure of each task object varies depending on its 'kind'.
     */
    #[JsonProperty('workflow'), ArrayType([AutomationsGetResponseDataWorkflowItem::class])]
    private array $workflow;

    /**
     * @var value-of<AutomationsGetResponseDataStatus> $status Current status of the automation
     */
    #[JsonProperty('status')]
     ...
     *   workflow: array<AutomationsGetResponseDataWorkflowItem>,
    ...
    /**
     * @return array<AutomationsGetResponseDataWorkflowItem>
     */
    ...
    /**
     * @param array<AutomationsGetResponseDataWorkflowItem> $value
     */
