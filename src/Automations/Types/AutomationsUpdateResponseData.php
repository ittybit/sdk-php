...
class AutomationsUpdateResponseData extends JsonSerializableType
{
    ...
    /**
     * @var AutomationsUpdateResponseDataTrigger $trigger
     */
     ...
     * )> $workflow
     */
    #[JsonProperty('workflow'), ArrayType([new Union(AutomationsUpdateResponseDataWorkflowItemRef::class, AutomationsUpdateResponseDataWorkflowItemConditions::class)])]
    private array $workflow;

    /**
     * @var value-of<AutomationsUpdateResponseDataStatus> $status
     */
    #[JsonProperty('status')]
