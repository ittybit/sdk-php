...
class AutomationsListResponseDataItem extends JsonSerializableType
{
    ...
    /**
     * @var AutomationsListResponseDataItemTrigger $trigger The event and conditions that trigger this automation.
     */
    #[JsonProperty('trigger')]
    private AutomationsListResponseDataItemTrigger $trigger;

    /**
     * @var array<AutomationsListResponseDataItemWorkflowItem> $workflow The sequence of tasks to be executed when the automation is triggered. The structure of each task object varies depending on its 'kind'.
     */
    #[JsonProperty('workflow'), ArrayType([AutomationsListResponseDataItemWorkflowItem::class])]
    private array $workflow;

    /**
     * @var value-of<AutomationsListResponseDataItemStatus> $status Current status of the automation
     */
    #[JsonProperty('status')]
     ...
     *   workflow: array<AutomationsListResponseDataItemWorkflowItem>,
    ...
    /**
     * @return array<AutomationsListResponseDataItemWorkflowItem>
     */
    ...
    /**
     * @param array<AutomationsListResponseDataItemWorkflowItem> $value
     */
