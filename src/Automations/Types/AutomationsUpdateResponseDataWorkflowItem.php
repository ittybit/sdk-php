...
class AutomationsUpdateResponseDataWorkflowItem extends JsonSerializableType
{
    /**
     * @var value-of<AutomationsUpdateResponseDataWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @param array{
     *   kind: value-of<AutomationsUpdateResponseDataWorkflowItemKind>,
     *   label?: ?string,
     *   format?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return value-of<AutomationsUpdateResponseDataWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<AutomationsUpdateResponseDataWorkflowItemKind> $value
     */
