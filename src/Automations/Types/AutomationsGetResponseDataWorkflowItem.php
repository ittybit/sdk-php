...
class AutomationsGetResponseDataWorkflowItem extends JsonSerializableType
{
    /**
     * @var value-of<AutomationsGetResponseDataWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @param array{
     *   kind: value-of<AutomationsGetResponseDataWorkflowItemKind>,
     *   label?: ?string,
     *   format?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return value-of<AutomationsGetResponseDataWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<AutomationsGetResponseDataWorkflowItemKind> $value
     */
