...
class AutomationsListResponseDataItemWorkflowItem extends JsonSerializableType
{
    /**
     * @var value-of<AutomationsListResponseDataItemWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @param array{
     *   kind: value-of<AutomationsListResponseDataItemWorkflowItemKind>,
     *   label?: ?string,
     *   format?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return value-of<AutomationsListResponseDataItemWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<AutomationsListResponseDataItemWorkflowItemKind> $value
     */
