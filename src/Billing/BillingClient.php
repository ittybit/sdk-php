...
namespace Ittybit\Billing;

use GuzzleHttp\ClientInterface;
use Ittybit\Core\Client\RawClient;
use Ittybit\Billing\Types\GetBillingResponse;
...
class BillingClient
{
     ...
     */
    public function getBillingInformationForTheOrganization(?array $options = null): GetBillingResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return GetBillingResponse::fromJson($json);
            }
