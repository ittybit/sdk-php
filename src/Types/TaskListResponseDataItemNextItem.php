...
class TaskListResponseDataItemNextItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TaskListResponseDataItemNextItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TaskListResponseDataItemNextItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskListResponseDataItemNextItemKind>,
     *   status: value-of<TaskListResponseDataItemNextItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TaskListResponseDataItemNextItemKind>
     */
    ...
    /**
     * @param value-of<TaskListResponseDataItemNextItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskListResponseDataItemNextItemStatus>
     */
    ...
    /**
     * @param value-of<TaskListResponseDataItemNextItemStatus> $value
     */
