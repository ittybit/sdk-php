...
class TaskListResponseDataItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<TaskListResponseDataItemKind> $kind
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var value-of<TaskListResponseDataItemStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?TaskListResponseDataItemResults $results
     */
    #[JsonProperty('results')]
    private ?TaskListResponseDataItemResults $results;

    /**
     * @param array{
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskListResponseDataItemKind>,
     *   status: value-of<TaskListResponseDataItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     ...
     *   results?: ?TaskListResponseDataItemResults,
     * } $values
     */
    ...
    /**
     * @return value-of<TaskListResponseDataItemKind>
     */
    ...
    /**
     * @param value-of<TaskListResponseDataItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskListResponseDataItemStatus>
     */
    ...
    /**
     * @param value-of<TaskListResponseDataItemStatus> $value
     */
    ...
    /**
     * @return ?TaskListResponseDataItemResults
     */
    public function getResults(): ?TaskListResponseDataItemResults
    {
        return $this->results;
    }

    /**
     * @param ?TaskListResponseDataItemResults $value
     */
    public function setResults(?TaskListResponseDataItemResults $value = null): self
    {
        $this->results = $value;
        return $this;
    }
