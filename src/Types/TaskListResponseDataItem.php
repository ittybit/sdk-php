...
class TaskListResponseDataItem extends JsonSerializableType
{
    ...
    /**
     * @var value-of<TaskListResponseDataItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var value-of<TaskListResponseDataItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?array<TaskListResponseDataItemWorkflowItem> $workflow Array of nested task objects representing the steps within this workflow task.
     */
    #[JsonProperty('workflow'), ArrayType([TaskListResponseDataItemWorkflowItem::class])]
    private ?array $workflow;

    /**
     * @var ?array<TaskListResponseDataItemNextItem> $next Array representing subsequent tasks (e.g., in an automation). Structure may vary.
     */
    #[JsonProperty('next'), ArrayType([TaskListResponseDataItemNextItem::class])]
    private ?array $next;
     ...
     *   createdBy?: ?string,
     *   parentId?: ?string,
     *   workflow?: ?array<TaskListResponseDataItemWorkflowItem>,
     *   next?: ?array<TaskListResponseDataItemNextItem>,
    ...
    /**
     * @return ?array<TaskListResponseDataItemWorkflowItem>
     */
    ...
    /**
     * @param ?array<TaskListResponseDataItemWorkflowItem> $value
     */
    ...
    /**
     * @return ?array<TaskListResponseDataItemNextItem>
     */
    ...
    /**
     * @param ?array<TaskListResponseDataItemNextItem> $value
     */
