...
class TaskListResponseDataItemWorkflowItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TaskListResponseDataItemWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TaskListResponseDataItemWorkflowItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskListResponseDataItemWorkflowItemKind>,
     *   status: value-of<TaskListResponseDataItemWorkflowItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TaskListResponseDataItemWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<TaskListResponseDataItemWorkflowItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskListResponseDataItemWorkflowItemStatus>
     */
    ...
    /**
     * @param value-of<TaskListResponseDataItemWorkflowItemStatus> $value
     */
