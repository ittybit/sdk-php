...
class MediaListResponseDataItem extends JsonSerializableType
{
    ...
    /**
     * @var value-of<MediaListResponseDataItemKind> $kind The primary kind of the media item, derived from its sources.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var array<MediaListResponseDataItemSourcesItem> $sources Array of source files associated with this media item.
     */
    #[JsonProperty('sources'), ArrayType([MediaListResponseDataItemSourcesItem::class])]
    ...
    /**
     * @var value-of<MediaListResponseDataItemStatus> $status Processing status.
     */
    #[JsonProperty('status')]
     ...
     *   type: string,
     *   sources: array<MediaListResponseDataItemSourcesItem>,
     *   original: string,
     *   created: DateTime,
     *   updated: DateTime,
     *   status: value-of<MediaListResponseDataItemStatus>,
     *   width?: ?int,
     *   height?: ?int,
     *   duration?: ?float,
     *   filesize?: ?int,
    ...
    /**
     * @return array<MediaListResponseDataItemSourcesItem>
     */
    ...
    /**
     * @param array<MediaListResponseDataItemSourcesItem> $value
     */
    ...
    /**
     * @return value-of<MediaListResponseDataItemStatus>
     */
    ...
    /**
     * @param value-of<MediaListResponseDataItemStatus> $value
     */
