...
class AutomationWorkflowItem extends JsonSerializableType
{
    /**
     * @var value-of<AutomationWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @param array{
     *   kind: value-of<AutomationWorkflowItemKind>,
     *   label?: ?string,
     *   format?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return value-of<AutomationWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<AutomationWorkflowItemKind> $value
     */
