...
class TaskListResponseItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<TaskListResponseItemKind> $kind
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var value-of<TaskListResponseItemStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?TaskListResponseItemResults $results
     */
    #[JsonProperty('results')]
    private ?TaskListResponseItemResults $results;

    /**
     * @param array{
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskListResponseItemKind>,
     *   status: value-of<TaskListResponseItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     ...
     *   results?: ?TaskListResponseItemResults,
     * } $values
     */
    ...
    /**
     * @return value-of<TaskListResponseItemKind>
     */
    ...
    /**
     * @param value-of<TaskListResponseItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskListResponseItemStatus>
     */
    ...
    /**
     * @param value-of<TaskListResponseItemStatus> $value
     */
    ...
    /**
     * @return ?TaskListResponseItemResults
     */
    public function getResults(): ?TaskListResponseItemResults
    {
        return $this->results;
    }

    /**
     * @param ?TaskListResponseItemResults $value
     */
    public function setResults(?TaskListResponseItemResults $value = null): self
    {
        $this->results = $value;
        return $this;
    }
