...
class TaskWorkflowItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TaskWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TaskWorkflowItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskWorkflowItemKind>,
     *   status: value-of<TaskWorkflowItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TaskWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<TaskWorkflowItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskWorkflowItemStatus>
     */
    ...
    /**
     * @param value-of<TaskWorkflowItemStatus> $value
     */
