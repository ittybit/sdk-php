...
class TaskNextItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TaskNextItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TaskNextItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskNextItemKind>,
     *   status: value-of<TaskNextItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TaskNextItemKind>
     */
    ...
    /**
     * @param value-of<TaskNextItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskNextItemStatus>
     */
    ...
    /**
     * @param value-of<TaskNextItemStatus> $value
     */
