...
class TaskResponseDataNextItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TaskResponseDataNextItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TaskResponseDataNextItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TaskResponseDataNextItemKind>,
     *   status: value-of<TaskResponseDataNextItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TaskResponseDataNextItemKind>
     */
    ...
    /**
     * @param value-of<TaskResponseDataNextItemKind> $value
     */
    ...
    /**
     * @return value-of<TaskResponseDataNextItemStatus>
     */
    ...
    /**
     * @param value-of<TaskResponseDataNextItemStatus> $value
     */
