...
class AutomationListResponseDataItemWorkflowItem extends JsonSerializableType
{
    /**
     * @var value-of<AutomationListResponseDataItemWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @param array{
     *   kind: value-of<AutomationListResponseDataItemWorkflowItemKind>,
     *   label?: ?string,
     *   format?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return value-of<AutomationListResponseDataItemWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<AutomationListResponseDataItemWorkflowItemKind> $value
     */
