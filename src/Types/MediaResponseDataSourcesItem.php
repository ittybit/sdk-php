 ...
 */
class MediaResponseDataSourcesItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<MediaResponseDataSourcesItemKind> $kind The general type of media (e.g., video, image).
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var ?value-of<MediaResponseDataSourcesItemOrientation> $orientation Visual orientation.
     */
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<MediaResponseDataSourcesItemKind>,
     *   format: string,
     *   type: string,
     *   filesize: int,
     *   original: bool,
     ...
     *   width?: ?int,
     *   height?: ?int,
     *   orientation?: ?value-of<MediaResponseDataSourcesItemOrientation>,
     *   duration?: ?float,
     *   fps?: ?float,
     *   bitrate?: ?int,
     *   label?: ?string,
    ...
    /**
     * @return value-of<MediaResponseDataSourcesItemKind>
     */
    ...
    /**
     * @param value-of<MediaResponseDataSourcesItemKind> $value
     */
    ...
    /**
     * @return ?value-of<MediaResponseDataSourcesItemOrientation>
     */
    ...
    /**
     * @param ?value-of<MediaResponseDataSourcesItemOrientation> $value
     */
