...
class MediaResponseData extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<MediaResponseDataKind> $kind
     */
    #[JsonProperty('kind')]
    private ?string $kind;
    ...
    /**
     * @var array<MediaResponseDataFilesItem> $files
     */
    #[JsonProperty('files'), ArrayType([MediaResponseDataFilesItem::class])]
    private array $files;
     ...
     *   id: string,
     *   object: string,
     *   files: array<MediaResponseDataFilesItem>,
    ...
    /**
     * @return array<MediaResponseDataFilesItem>
     */
    ...
    /**
     * @param array<MediaResponseDataFilesItem> $value
     */
