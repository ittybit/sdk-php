...
class MediaResponseData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<MediaResponseDataKind> $kind The primary kind of the media item, derived from its sources.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var array<MediaResponseDataSourcesItem> $sources Array of source files associated with this media item.
     */
    #[JsonProperty('sources'), ArrayType([MediaResponseDataSourcesItem::class])]
    ...
    /**
     * @var value-of<MediaResponseDataStatus> $status Processing status.
     */
    #[JsonProperty('status')]
     ...
     *   projectId: string,
     *   liveMode: bool,
     *   kind: value-of<MediaResponseDataKind>,
     *   type: string,
     *   sources: array<MediaResponseDataSourcesItem>,
     *   original: string,
     *   created: DateTime,
     *   updated: DateTime,
     *   status: value-of<MediaResponseDataStatus>,
     *   width?: ?int,
     *   height?: ?int,
     *   duration?: ?float,
     *   filesize?: ?int,
    ...
    /**
     * @return value-of<MediaResponseDataKind>
     */
    ...
    /**
     * @param value-of<MediaResponseDataKind> $value
     */
    ...
    /**
     * @return array<MediaResponseDataSourcesItem>
     */
    ...
    /**
     * @param array<MediaResponseDataSourcesItem> $value
     */
    ...
    /**
     * @return value-of<MediaResponseDataStatus>
     */
    ...
    /**
     * @param value-of<MediaResponseDataStatus> $value
     */
