...
class MediaResponseMeta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<MediaResponseMetaType> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   projectId?: ?string,
     *   version?: ?string,
     *   type?: ?value-of<MediaResponseMetaType>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<MediaResponseMetaType>
     */
    ...
    /**
     * @param ?value-of<MediaResponseMetaType> $value
     */
