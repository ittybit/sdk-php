 ...
 */
class MediaSourcesItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<MediaSourcesItemKind> $kind The general type of media (e.g., video, image).
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var ?value-of<MediaSourcesItemOrientation> $orientation Visual orientation.
     */
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<MediaSourcesItemKind>,
     *   format: string,
     *   type: string,
     *   filesize: int,
     *   original: bool,
     ...
     *   width?: ?int,
     *   height?: ?int,
     *   orientation?: ?value-of<MediaSourcesItemOrientation>,
     *   duration?: ?float,
     *   fps?: ?float,
     *   bitrate?: ?int,
     *   label?: ?string,
    ...
    /**
     * @return value-of<MediaSourcesItemKind>
     */
    ...
    /**
     * @param value-of<MediaSourcesItemKind> $value
     */
    ...
    /**
     * @return ?value-of<MediaSourcesItemOrientation>
     */
    ...
    /**
     * @param ?value-of<MediaSourcesItemOrientation> $value
     */
