...
class AutomationResponseDataWorkflowItem extends JsonSerializableType
{
    /**
     * @var value-of<AutomationResponseDataWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @param array{
     *   kind: value-of<AutomationResponseDataWorkflowItemKind>,
     *   label?: ?string,
     *   format?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return value-of<AutomationResponseDataWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<AutomationResponseDataWorkflowItemKind> $value
     */
