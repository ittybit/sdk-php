 ...
 */
class MediaGetResponseDataSourcesItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<MediaGetResponseDataSourcesItemKind> $kind The general type of media (e.g., video, image).
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var ?value-of<MediaGetResponseDataSourcesItemOrientation> $orientation Visual orientation.
     */
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<MediaGetResponseDataSourcesItemKind>,
     *   format: string,
     *   type: string,
     *   filesize: int,
     *   original: bool,
     ...
     *   width?: ?int,
     *   height?: ?int,
     *   orientation?: ?value-of<MediaGetResponseDataSourcesItemOrientation>,
     *   duration?: ?float,
     *   fps?: ?float,
     *   bitrate?: ?int,
     *   label?: ?string,
    ...
    /**
     * @return value-of<MediaGetResponseDataSourcesItemKind>
     */
    ...
    /**
     * @param value-of<MediaGetResponseDataSourcesItemKind> $value
     */
    ...
    /**
     * @return ?value-of<MediaGetResponseDataSourcesItemOrientation>
     */
    ...
    /**
     * @param ?value-of<MediaGetResponseDataSourcesItemOrientation> $value
     */
