...
class MediaCreateResponse extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<MediaCreateResponseKind> $kind
     */
    #[JsonProperty('kind')]
    private ?string $kind;
    ...
    /**
     * @var array<MediaCreateResponseFilesItem> $files
     */
    #[JsonProperty('files'), ArrayType([MediaCreateResponseFilesItem::class])]
    private array $files;
     ...
     *   id: string,
     *   object: string,
     *   files: array<MediaCreateResponseFilesItem>,
     *   urls: array<string, mixed>,
     *   created: DateTime,
     *   updated: DateTime,
     *   kind?: ?value-of<MediaCreateResponseKind>,
     *   title?: ?string,
     *   alt?: ?string,
     *   width?: ?int,
     *   height?: ?int,
    ...
    /**
     * @return ?value-of<MediaCreateResponseKind>
     */
    ...
    /**
     * @param ?value-of<MediaCreateResponseKind> $value
     */
    ...
    /**
     * @return array<MediaCreateResponseFilesItem>
     */
    ...
    /**
     * @param array<MediaCreateResponseFilesItem> $value
     */
