...
class MediaCreateResponse extends JsonSerializableType
{
    ...
    /**
     * @var ?MediaCreateResponseError $error
     */
    #[JsonProperty('error')]
    private ?MediaCreateResponseError $error;
     ...
     *   error?: ?MediaCreateResponseError,
    ...
    /**
     * @return ?MediaCreateResponseError
     */
    public function getError(): ?MediaCreateResponseError
    {
        return $this->error;
    }

    /**
     * @param ?MediaCreateResponseError $value
     */
    public function setError(?MediaCreateResponseError $value = null): self
    {
        $this->error = $value;
        return $this;
    }
