...
class MediaCreateResponseData extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<MediaCreateResponseDataKind> $kind
     */
    #[JsonProperty('kind')]
    private ?string $kind;
    ...
    /**
     * @var array<MediaCreateResponseDataFilesItem> $files
     */
    #[JsonProperty('files'), ArrayType([MediaCreateResponseDataFilesItem::class])]
    private array $files;
     ...
     *   id: string,
     *   object: string,
     *   files: array<MediaCreateResponseDataFilesItem>,
    ...
    /**
     * @return array<MediaCreateResponseDataFilesItem>
     */
    ...
    /**
     * @param array<MediaCreateResponseDataFilesItem> $value
     */
