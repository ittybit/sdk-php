 ...
 */
class MediaCreateResponseDataSourcesItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<MediaCreateResponseDataSourcesItemKind> $kind The general type of media (e.g., video, image).
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var ?value-of<MediaCreateResponseDataSourcesItemOrientation> $orientation Visual orientation.
     */
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<MediaCreateResponseDataSourcesItemKind>,
     *   format: string,
     *   type: string,
     *   filesize: int,
     *   original: bool,
     ...
     *   width?: ?int,
     *   height?: ?int,
     *   orientation?: ?value-of<MediaCreateResponseDataSourcesItemOrientation>,
     *   duration?: ?float,
     *   fps?: ?float,
     *   bitrate?: ?int,
     *   label?: ?string,
    ...
    /**
     * @return value-of<MediaCreateResponseDataSourcesItemKind>
     */
    ...
    /**
     * @param value-of<MediaCreateResponseDataSourcesItemKind> $value
     */
    ...
    /**
     * @return ?value-of<MediaCreateResponseDataSourcesItemOrientation>
     */
    ...
    /**
     * @param ?value-of<MediaCreateResponseDataSourcesItemOrientation> $value
     */
