...
class MediaGetResponseData extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<MediaGetResponseDataKind> $kind
     */
    #[JsonProperty('kind')]
    private ?string $kind;
    ...
    /**
     * @var array<MediaGetResponseDataFilesItem> $files
     */
    #[JsonProperty('files'), ArrayType([MediaGetResponseDataFilesItem::class])]
    private array $files;
     ...
     *   id: string,
     *   object: string,
     *   files: array<MediaGetResponseDataFilesItem>,
    ...
    /**
     * @return array<MediaGetResponseDataFilesItem>
     */
    ...
    /**
     * @param array<MediaGetResponseDataFilesItem> $value
     */
