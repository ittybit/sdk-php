...
class SignaturesCreateResponseMeta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<SignaturesCreateResponseMetaType> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   projectId?: ?string,
     *   version?: ?string,
     *   type?: ?value-of<SignaturesCreateResponseMetaType>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<SignaturesCreateResponseMetaType>
     */
    ...
    /**
     * @param ?value-of<SignaturesCreateResponseMetaType> $value
     */
