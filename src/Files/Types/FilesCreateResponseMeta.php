...
class FilesCreateResponseMeta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<FilesCreateResponseMetaType> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   projectId?: ?string,
     *   version?: ?string,
     *   type?: ?value-of<FilesCreateResponseMetaType>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<FilesCreateResponseMetaType>
     */
    ...
    /**
     * @param ?value-of<FilesCreateResponseMetaType> $value
     */
