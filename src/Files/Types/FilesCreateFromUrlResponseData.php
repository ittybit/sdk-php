...
class FilesCreateFromUrlResponseData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<FilesCreateFromUrlResponseDataKind> $kind The general type of media.
     */
    #[JsonProperty('kind')]
    private string $kind;
     ...
     *   mediaId: string,
     *   object: string,
     *   kind: value-of<FilesCreateFromUrlResponseDataKind>,
     *   format: string,
     *   type: string,
     *   filesize: int,
     *   filename: string,
    ...
    /**
     * @return value-of<FilesCreateFromUrlResponseDataKind>
     */
    ...
    /**
     * @param value-of<FilesCreateFromUrlResponseDataKind> $value
     */
