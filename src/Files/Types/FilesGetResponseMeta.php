...
class FilesGetResponseMeta extends JsonSerializableType
{
    ...
    /**
     * @var ?value-of<FilesGetResponseMetaType> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   projectId?: ?string,
     *   version?: ?string,
     *   type?: ?value-of<FilesGetResponseMetaType>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<FilesGetResponseMetaType>
     */
    ...
    /**
     * @param ?value-of<FilesGetResponseMetaType> $value
     */
