...
class FilesUpdateMetadataResponseData extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<FilesUpdateMetadataResponseDataKind> $kind The general type of media.
     */
    #[JsonProperty('kind')]
    private string $kind;
     ...
     *   mediaId: string,
     *   object: string,
     *   kind: value-of<FilesUpdateMetadataResponseDataKind>,
     *   format: string,
     *   type: string,
     *   filesize: int,
     *   filename: string,
    ...
    /**
     * @return value-of<FilesUpdateMetadataResponseDataKind>
     */
    ...
    /**
     * @param value-of<FilesUpdateMetadataResponseDataKind> $value
     */
