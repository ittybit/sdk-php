...
class FilesUpdateResponseMeta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<FilesUpdateResponseMetaType> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   projectId?: ?string,
     *   version?: ?string,
     *   type?: ?value-of<FilesUpdateResponseMetaType>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<FilesUpdateResponseMetaType>
     */
    ...
    /**
     * @param ?value-of<FilesUpdateResponseMetaType> $value
     */
