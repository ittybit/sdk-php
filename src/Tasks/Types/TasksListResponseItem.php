...
class TasksListResponseItem extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<TasksListResponseItemKind> $kind
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var value-of<TasksListResponseItemStatus> $status
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?TasksListResponseItemResults $results
     */
    #[JsonProperty('results')]
    private ?TasksListResponseItemResults $results;

    /**
     * @param array{
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksListResponseItemKind>,
     *   status: value-of<TasksListResponseItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     ...
     *   results?: ?TasksListResponseItemResults,
     * } $values
     */
    ...
    /**
     * @return value-of<TasksListResponseItemKind>
     */
    ...
    /**
     * @param value-of<TasksListResponseItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksListResponseItemStatus>
     */
    ...
    /**
     * @param value-of<TasksListResponseItemStatus> $value
     */
    ...
    /**
     * @return ?TasksListResponseItemResults
     */
    public function getResults(): ?TasksListResponseItemResults
    {
        return $this->results;
    }

    /**
     * @param ?TasksListResponseItemResults $value
     */
    public function setResults(?TasksListResponseItemResults $value = null): self
    {
        $this->results = $value;
        return $this;
    }
