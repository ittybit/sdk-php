...
class TasksGetResponseDataWorkflowItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksGetResponseDataWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TasksGetResponseDataWorkflowItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksGetResponseDataWorkflowItemKind>,
     *   status: value-of<TasksGetResponseDataWorkflowItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TasksGetResponseDataWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<TasksGetResponseDataWorkflowItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksGetResponseDataWorkflowItemStatus>
     */
    ...
    /**
     * @param value-of<TasksGetResponseDataWorkflowItemStatus> $value
     */
