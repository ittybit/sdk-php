...
class TasksCreateResponseDataNextItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksCreateResponseDataNextItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TasksCreateResponseDataNextItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksCreateResponseDataNextItemKind>,
     *   status: value-of<TasksCreateResponseDataNextItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TasksCreateResponseDataNextItemKind>
     */
    ...
    /**
     * @param value-of<TasksCreateResponseDataNextItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksCreateResponseDataNextItemStatus>
     */
    ...
    /**
     * @param value-of<TasksCreateResponseDataNextItemStatus> $value
     */
