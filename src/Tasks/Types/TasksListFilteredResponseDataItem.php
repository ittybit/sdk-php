...
class TasksListFilteredResponseDataItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksListFilteredResponseDataItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var value-of<TasksListFilteredResponseDataItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?array<TasksListFilteredResponseDataItemWorkflowItem> $workflow Array of nested task objects representing the steps within this workflow task.
     */
    #[JsonProperty('workflow'), ArrayType([TasksListFilteredResponseDataItemWorkflowItem::class])]
    private ?array $workflow;

    /**
     * @var ?array<TasksListFilteredResponseDataItemNextItem> $next Array representing subsequent tasks (e.g., in an automation). Structure may vary.
     */
    #[JsonProperty('next'), ArrayType([TasksListFilteredResponseDataItemNextItem::class])]
    private ?array $next;

    /**
     * @var ?TasksListFilteredResponseDataItemResults $results
     */
    #[JsonProperty('results')]
    private ?TasksListFilteredResponseDataItemResults $results;

    /**
     * @param array{
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksListFilteredResponseDataItemKind>,
     *   status: value-of<TasksListFilteredResponseDataItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     ...
     *   createdBy?: ?string,
     *   parentId?: ?string,
     *   workflow?: ?array<TasksListFilteredResponseDataItemWorkflowItem>,
     *   next?: ?array<TasksListFilteredResponseDataItemNextItem>,
     *   results?: ?TasksListFilteredResponseDataItemResults,
     * } $values
     */
    ...
    /**
     * @return value-of<TasksListFilteredResponseDataItemKind>
     */
    ...
    /**
     * @param value-of<TasksListFilteredResponseDataItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksListFilteredResponseDataItemStatus>
     */
    ...
    /**
     * @param value-of<TasksListFilteredResponseDataItemStatus> $value
     */
    ...
    /**
     * @return ?array<TasksListFilteredResponseDataItemWorkflowItem>
     */
    ...
    /**
     * @param ?array<TasksListFilteredResponseDataItemWorkflowItem> $value
     */
    ...
    /**
     * @return ?array<TasksListFilteredResponseDataItemNextItem>
     */
    ...
    /**
     * @param ?array<TasksListFilteredResponseDataItemNextItem> $value
     */
    ...
    /**
     * @return ?TasksListFilteredResponseDataItemResults
     */
    public function getResults(): ?TasksListFilteredResponseDataItemResults
    {
        return $this->results;
    }

    /**
     * @param ?TasksListFilteredResponseDataItemResults $value
     */
    public function setResults(?TasksListFilteredResponseDataItemResults $value = null): self
    {
        $this->results = $value;
        return $this;
    }
