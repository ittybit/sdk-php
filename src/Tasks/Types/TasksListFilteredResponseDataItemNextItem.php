...
class TasksListFilteredResponseDataItemNextItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksListFilteredResponseDataItemNextItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TasksListFilteredResponseDataItemNextItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksListFilteredResponseDataItemNextItemKind>,
     *   status: value-of<TasksListFilteredResponseDataItemNextItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TasksListFilteredResponseDataItemNextItemKind>
     */
    ...
    /**
     * @param value-of<TasksListFilteredResponseDataItemNextItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksListFilteredResponseDataItemNextItemStatus>
     */
    ...
    /**
     * @param value-of<TasksListFilteredResponseDataItemNextItemStatus> $value
     */
