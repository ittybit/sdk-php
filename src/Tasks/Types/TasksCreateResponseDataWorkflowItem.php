...
class TasksCreateResponseDataWorkflowItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksCreateResponseDataWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TasksCreateResponseDataWorkflowItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksCreateResponseDataWorkflowItemKind>,
     *   status: value-of<TasksCreateResponseDataWorkflowItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TasksCreateResponseDataWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<TasksCreateResponseDataWorkflowItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksCreateResponseDataWorkflowItemStatus>
     */
    ...
    /**
     * @param value-of<TasksCreateResponseDataWorkflowItemStatus> $value
     */
