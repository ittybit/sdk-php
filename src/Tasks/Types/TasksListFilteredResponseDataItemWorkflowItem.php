...
class TasksListFilteredResponseDataItemWorkflowItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksListFilteredResponseDataItemWorkflowItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TasksListFilteredResponseDataItemWorkflowItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksListFilteredResponseDataItemWorkflowItemKind>,
     *   status: value-of<TasksListFilteredResponseDataItemWorkflowItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TasksListFilteredResponseDataItemWorkflowItemKind>
     */
    ...
    /**
     * @param value-of<TasksListFilteredResponseDataItemWorkflowItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksListFilteredResponseDataItemWorkflowItemStatus>
     */
    ...
    /**
     * @param value-of<TasksListFilteredResponseDataItemWorkflowItemStatus> $value
     */
