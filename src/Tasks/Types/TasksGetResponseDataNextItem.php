...
class TasksGetResponseDataNextItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<TasksGetResponseDataNextItemKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;

    /**
     * @var value-of<TasksGetResponseDataNextItemStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
     ...
     *   id: string,
     *   object: string,
     *   kind: value-of<TasksGetResponseDataNextItemKind>,
     *   status: value-of<TasksGetResponseDataNextItemStatus>,
     *   created: DateTime,
     *   updated: DateTime,
     *   progress?: ?int,
     *   error?: ?string,
    ...
    /**
     * @return value-of<TasksGetResponseDataNextItemKind>
     */
    ...
    /**
     * @param value-of<TasksGetResponseDataNextItemKind> $value
     */
    ...
    /**
     * @return value-of<TasksGetResponseDataNextItemStatus>
     */
    ...
    /**
     * @param value-of<TasksGetResponseDataNextItemStatus> $value
     */
