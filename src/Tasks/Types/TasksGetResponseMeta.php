...
class TasksGetResponseMeta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<TasksGetResponseMetaType> $type
     */
    #[JsonProperty('type')]
    private ?string $type;
     ...
     *   projectId?: ?string,
     *   version?: ?string,
     *   type?: ?value-of<TasksGetResponseMetaType>,
     * } $values
     */
    ...
    /**
     * @return ?value-of<TasksGetResponseMetaType>
     */
    ...
    /**
     * @param ?value-of<TasksGetResponseMetaType> $value
     */
