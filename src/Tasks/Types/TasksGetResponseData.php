...
class TasksGetResponseData extends JsonSerializableType
{
    ...
    /**
     * @var value-of<TasksGetResponseDataKind> $kind The type of operation the task performs.
     */
    #[JsonProperty('kind')]
    private string $kind;
    ...
    /**
     * @var value-of<TasksGetResponseDataStatus> $status Current status of the task.
     */
    #[JsonProperty('status')]
    ...
    /**
     * @var ?array<TasksGetResponseDataWorkflowItem> $workflow Array of nested task objects representing the steps within this workflow task.
     */
    #[JsonProperty('workflow'), ArrayType([TasksGetResponseDataWorkflowItem::class])]
    private ?array $workflow;

    /**
     * @var ?array<TasksGetResponseDataNextItem> $next Array representing subsequent tasks (e.g., in an automation). Structure may vary.
     */
    #[JsonProperty('next'), ArrayType([TasksGetResponseDataNextItem::class])]
    private ?array $next;
     ...
     *   createdBy?: ?string,
     *   parentId?: ?string,
     *   workflow?: ?array<TasksGetResponseDataWorkflowItem>,
     *   next?: ?array<TasksGetResponseDataNextItem>,
    ...
    /**
     * @return ?array<TasksGetResponseDataWorkflowItem>
     */
    ...
    /**
     * @param ?array<TasksGetResponseDataWorkflowItem> $value
     */
    ...
    /**
     * @return ?array<TasksGetResponseDataNextItem>
     */
    ...
    /**
     * @param ?array<TasksGetResponseDataNextItem> $value
     */
